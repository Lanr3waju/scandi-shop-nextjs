        ...
        <>
            ...
            <section className="w-2/5">
                ...
                {product?.attributes.map((attr) => (
                    <ul key={attr.id}>
                        <li className="uppercase font-bold mt-7">
                            {attr.name}
                            :
                        </li>
                        <li>
                ...
                <p className="font-bold text-2xl font-RobotoCondensed">{currency}  {price?.amount}</p>
                ...
                <p className="font-medium tracking-wider p-2 font-Roboto mt-10 leading-6 max-h-56 mb-3 scrollbar">{product && parse(product.description)}</p>
            </section>
        </>
    );
}
